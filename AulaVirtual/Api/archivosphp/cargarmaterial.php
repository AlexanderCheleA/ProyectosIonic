...
if($_SERVER['REQUEST_METHOD']==='GET'){
    ...
    if(isset($_GET['id'])){
        ...
        $cadenaSql="";  
        $cadenaSql= $cadenaSql."select c.idContenido, c.archivoContenidoDocente, c.tituloContenido, c.descripcionContenido, c.fechaDesdeContenido, c.fechaHastaContenido, c.calificaconContenido, c.idMateria, c.idQuimestre, c.idParcial, c.idTipoActividad, c.actualFechaContenido ";
        $cadenaSql= $cadenaSql." from contenido c INNER JOIN materia m ON c.idMateria=m.idMateria ";
        $cadenaSql= $cadenaSql." where c.idMateria=:id";
