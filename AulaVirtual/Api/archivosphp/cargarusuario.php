...
if($_SERVER['REQUEST_METHOD']==='GET'){
    ...
    if(isset($_GET['id'])){
        $cadenaSql="";
        $cadenaSql= $cadenaSql."select p.idPersona, p.cedulaPersona, p.fotoPersona, p.primerNombrePersona, p.segundoNombrePersona, p.primerApellidoPersona, p.segundoApellidoPersona, p.telefonoPersona, p.correoPersona, p.edadPersona, s.detalleSexo ";
        $cadenaSql= $cadenaSql." from persona p INNER JOIN sexo s ON s.idSexo=p.idSexo ";
        $cadenaSql= $cadenaSql." where p.idPersona=:id";
